 ...
 <footer class="landing-footer bg-body footer-text">
     <div class="footer-top position-relative overflow-hidden z-1">
         <img src="Frontend/assets/img/front-pages/backgrounds/footer-bg-light.png" alt="footer bg"
             ...
             <div class="row gx-0 gy-6 g-lg-10">
                 ...
                 <div class="col-lg-3 col-md-4">
                     ...
                     <a href="javascript:void(0);" class="d-block mb-4"><img
                             src="Frontend/assets/img/front-pages/landing-page/apple-icon.png" alt="apple icon" /></a>
         ...
         <div
             ...
             <div>
                 <a href="https://github.com/pixinvent" class="me-3" target="_blank">
                     <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/front-pages/icons/github.svg"
                         alt="github icon" />
                 </a>
                 <a href="https://www.facebook.com/pixinvents/" class="me-3" target="_blank">
                     <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/front-pages/icons/facebook.svg"
                         alt="facebook icon" />
                 </a>
                 <a href="https://twitter.com/pixinvents" class="me-3" target="_blank">
                     <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/front-pages/icons/twitter.svg"
                         alt="twitter icon" />
                 </a>
                 <a href="https://www.instagram.com/pixinvents/" target="_blank">
                     <img src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/front-pages/icons/instagram.svg"
                         alt="google icon" />
                 </a>
             </div>
         </div>
