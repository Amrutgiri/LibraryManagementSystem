    ...
    <nav class="layout-navbar shadow-none py-0">
        <div class="container">
          <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
            ...
            <div
              class="navbar-brand app-brand demo d-flex py-0 py-lg-2 me-4 me-xl-8"
            >
              ...
              >
                <i
                  class="ti ti-menu-2 ti-lg align-middle text-heading fw-medium"
                ></i>
              </button>
                  ...
                  <li>
                    ...
                    >
                      <span class="align-middle"
                        ><i class="ti ti-sun me-3"></i>Light</span
                      >
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      <span class="align-middle"
                        ><i class="ti ti-moon-stars me-3"></i>Dark</span
                      >
                    </a>
                  </li>
                  <li>
