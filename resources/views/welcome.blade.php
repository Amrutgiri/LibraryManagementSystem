...
<section id="hero-animation">
    <div id="landingHero" class="section-py landing-hero position-relative">
      <img
        src="Frontend/assets/img/front-pages/backgrounds/hero-bg.png"
        alt="hero background"
      ...
      <div class="container">
        <div class="hero-text-box text-center position-relative">
          ...
          <div class="landing-hero-btn d-inline-block position-relative">
            <span
              class="hero-btn-item position-absolute d-none d-md-flex fw-medium"
              >Join community
              <img
                src="Frontend/assets/img/front-pages/icons/Join-community-arrow.png"
        ...
        <div id="heroDashboardAnimation" class="hero-animation-img">
          <a
            href="https://demos.pixinvent.com/vuexy-html-admin-template/html/vertical-menu-template/app-ecommerce-dashboard.html"
            target="_blank"
          >
            <div
              id="heroAnimationImg"
            ...
            >
              <img
                src="Frontend/assets/img/front-pages/landing-page/hero-dashboard-light.png"
                alt="hero dashboard"
                class="animation-img"
              ...
              />
              <img
                src="Frontend/assets/img/front-pages/landing-page/hero-elements-light.png"
                alt="hero elements"
    ...
    <div class="container">
      ...
      <h4 class="text-center mb-1">
        <span class="position-relative fw-extrabold z-1"
          >Everything you need
          <img
            src="Frontend/assets/img/front-pages/icons/section-title-icon.png"
            alt="laptop charging"
      ...
      <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="text-center mb-4">
            <img
              src="Frontend/assets/img/front-pages/icons/laptop.png"
              alt="laptop charging"
            />
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="text-center mb-4">
            <img
              src="Frontend/assets/img/front-pages/icons/rocket.png"
              alt="transition up"
            />
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="text-center mb-4">
            <img
              src="Frontend/assets/img/front-pages/icons/paper.png"
              alt="edit"
            />
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="text-center mb-4">
            <img
              src="Frontend/assets/img/front-pages/icons/check.png"
              alt="3d select solid"
            />
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="text-center mb-4">
            <img
              src="Frontend/assets/img/front-pages/icons/user.png"
              alt="lifebelt"
            />
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="text-center mb-4">
            <img
              src="Frontend/assets/img/front-pages/icons/keyboard.png"
              alt="google docs"
            />
          </div>
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    ...
                    >
                      <div class="mb-4">
                        <img
                          src="Frontend/assets/img/front-pages/branding/logo-1.png"
                          alt="client logo"
                      ...
                      <p>
                        ...
                        Bootstrap theme I've ever used. I can't wait to use
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    ...
                    >
                      <div class="mb-4">
                        <img
                          src="Frontend/assets/img/front-pages/branding/logo-2.png"
                          alt="client logo"
                          class="client-logo img-fluid"
                        />
                      </div>
                      <p>
                        ...
                        as Vuexy. It's my go to for building dashboard sites
                      ...
                      <div class="d-flex align-items-center">
                        <div class="avatar me-3 avatar-sm">
                          <img
                            src="Frontend/assets/img/avatars/2.png"
                            alt="Avatar"
                            class="rounded-circle"
                          />
                        </div>
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    ...
                    >
                      <div class="mb-4">
                        <img
                          src="Frontend/assets/img/front-pages/branding/logo-3.png"
                          alt="client logo"
                          class="client-logo img-fluid"
                        />
                      </div>
                      <p>
                        ...
                        docs are really easy to understand and it's always
                      ...
                      <div class="d-flex align-items-center">
                        <div class="avatar me-3 avatar-sm">
                          <img
                            src="Frontend/assets/img/avatars/3.png"
                            alt="Avatar"
                            class="rounded-circle"
                          />
                        </div>
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    ...
                    >
                      <div class="mb-4">
                        <img
                          src="Frontend/assets/img/front-pages/branding/logo-4.png"
                          alt="client logo"
                          class="client-logo img-fluid"
                        />
                      </div>
                      <p>
                        ...
                        into consideration, so I’m able to build any
                        interface I want.
                      </p>
                      <div class="text-warning mb-4">
                        <i class="ti ti-star-filled"></i>
                      ...
                      <div class="d-flex align-items-center">
                        <div class="avatar me-3 avatar-sm">
                          <img
                            src="Frontend/assets/img/avatars/4.png"
                            alt="Avatar"
                            class="rounded-circle"
                          />
                        </div>
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    ...
                    >
                      <div class="mb-4">
                        <img
                          src="Frontend/assets/img/front-pages/branding/logo-5.png"
                          alt="client logo"
                          class="client-logo img-fluid"
                        />
                      </div>
                      ...
                      <div class="d-flex align-items-center">
                        <div class="avatar me-3 avatar-sm">
                          <img
                            src="Frontend/assets/img/avatars/5.png"
                            alt="Avatar"
                            class="rounded-circle"
                          />
                        </div>
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    ...
                    >
                      <div class="mb-4">
                        <img
                          src="Frontend/assets/img/front-pages/branding/logo-6.png"
                          alt="client logo"
                          class="client-logo img-fluid"
                        />
                      </div>
      ...
      <div class="swiper-logo-carousel py-8">
        <div class="swiper" id="swiper-clients-logos">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img
                src="Frontend/assets/img/front-pages/branding/logo_1-light.png"
                alt="client logo"
                class="client-logo"
                data-app-light-img="front-pages/branding/logo_1-light.png"
                data-app-dark-img="front-pages/branding/logo_1-dark.html"
              />
            </div>
            <div class="swiper-slide">
              <img
                src="Frontend/assets/img/front-pages/branding/logo_2-light.png"
                alt="client logo"
                class="client-logo"
                data-app-light-img="front-pages/branding/logo_2-light.png"
                data-app-dark-img="front-pages/branding/logo_2-dark.html"
              />
            </div>
            <div class="swiper-slide">
              <img
                src="Frontend/assets/img/front-pages/branding/logo_3-light.png"
                alt="client logo"
                class="client-logo"
                data-app-light-img="front-pages/branding/logo_3-light.png"
                data-app-dark-img="front-pages/branding/logo_3-dark.html"
              />
            </div>
            <div class="swiper-slide">
              <img
                src="Frontend/assets/img/front-pages/branding/logo_4-light.png"
                alt="client logo"
                class="client-logo"
                data-app-light-img="front-pages/branding/logo_4-light.png"
                data-app-dark-img="front-pages/branding/logo_4-dark.html"
              />
            </div>
            <div class="swiper-slide">
              <img
                src="Frontend/assets/img/front-pages/branding/logo_5-light.png"
                alt="client logo"
                class="client-logo"
                data-app-light-img="front-pages/branding/logo_5-light.png"
                data-app-dark-img="front-pages/branding/logo_5-dark.html"
              />
            </div>
          </div>
        </div>
      ...
      <div class="row gy-12 mt-2">
        <div class="col-lg-3 col-sm-6">
          <div class="card mt-3 mt-lg-0 shadow-none">
            ...
            >
              <img
                src="Frontend/assets/img/front-pages/landing-page/team-member-1.png"
                class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                alt="human image"
              />
            </div>
            <div
              class="card-body border border-top-0 border-label-primary text-center"
            >
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card mt-3 mt-lg-0 shadow-none">
            ...
            >
              <img
                src="Frontend/assets/img/front-pages/landing-page/team-member-2.png"
                class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                alt="human image"
              />
            </div>
            <div
              class="card-body border border-top-0 border-label-info text-center"
            >
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card mt-3 mt-lg-0 shadow-none">
            ...
            >
              <img
                src="Frontend/assets/img/front-pages/landing-page/team-member-3.png"
                class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                alt="human image"
              />
            </div>
            <div
              class="card-body border border-top-0 border-label-danger text-center"
            >
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card mt-3 mt-lg-0 shadow-none">
            ...
            >
              <img
                src="Frontend/assets/img/front-pages/landing-page/team-member-4.png"
                class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                alt="human image"
              />
            </div>
            <div
              class="card-body border border-top-0 border-label-success text-center"
            >
      ...
      <div class="text-center mb-12">
        <div class="position-relative d-inline-block pt-3 pt-md-0">
          <label class="switch switch-sm switch-primary me-0">
            <span class="switch-label fs-6 text-body me-3"
              >Pay Monthly</span
            >
            <input
              type="checkbox"
          ...
          <div class="pricing-plans-item position-absolute d-flex">
            <img
              src="Frontend/assets/img/front-pages/icons/pricing-plans-arrow.png"
          ...
          <div class="card">
            <div class="card-header">
              <div class="text-center">
                <img
                  src="Frontend/assets/img/front-pages/icons/paper-airplane.png"
                ...
                >
                  <span
                    class="price-monthly h2 text-primary fw-extrabold mb-0"
                    >$19</span
                  >
                  <span
                    class="price-yearly h2 text-primary fw-extrabold mb-0 d-none"
                    >$14</span
                  >
            ...
            <div class="card-body">
              ...
              <div class="d-grid mt-8">
                <a href="payment-page.html" class="btn btn-label-primary"
                  >Get Started</a
                >
              </div>
            </div>
        ...
        <div class="col-xl-4 col-lg-6">
          <div class="card border border-primary shadow-xl">
            <div class="card-header">
              <div class="text-center">
                <img
                  src="Frontend/assets/img/front-pages/icons/plane.png"
                  alt="plane icon"
                  class="mb-8 pb-2"
                />
        ...
        <div class="col-xl-4 col-lg-6">
          <div class="card">
            <div class="card-header">
              <div class="text-center">
                <img
                  src="Frontend/assets/img/front-pages/icons/shuttle-rocket.png"
      ...
      <div class="row gy-6">
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="card border border-success shadow-none">
            <div class="card-body text-center">
              <img
                src="Frontend/assets/img/front-pages/icons/user-success.png"
                alt="laptop"
                class="mb-4"
              />
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="card border border-info shadow-none">
            <div class="card-body text-center">
              <img
                src="Frontend/assets/img/front-pages/icons/diamond-info.png"
                alt="laptop"
                class="mb-4"
              />
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="card border border-warning shadow-none">
            <div class="card-body text-center">
              <img
                src="Frontend/assets/img/front-pages/icons/check-warning.png"
                alt="laptop"
                class="mb-4"
              />
    ...
    <div class="container">
      ...
      <div class="row gy-12 align-items-center">
        <div class="col-lg-5">
          <div class="text-center">
            <img
              src="Frontend/assets/img/front-pages/landing-page/faq-boy-with-logos.png"
  ...
  >
    <img
      src="Frontend/assets/img/front-pages/backgrounds/cta-bg-light.png"
      class="position-absolute bottom-0 end-0 scaleX-n1-rtl h-100 w-100 z-n1"
      alt="cta image"
      data-app-light-img="front-pages/backgrounds/cta-bg-light.png"
      data-app-dark-img="front-pages/backgrounds/cta-bg-dark.html"
    />
    <div class="container">
      <div class="row align-items-center gy-12">
        <div class="col-lg-6 text-start text-sm-center text-lg-start">
          <h3 class="cta-title text-primary fw-bold mb-0">
        ...
        <div class="col-lg-6 pt-lg-12 text-center text-lg-end">
          <img
            src="Frontend/assets/img/front-pages/landing-page/cta-dashboard.png"
            alt="cta dashboard"
      ...
      <div class="row g-6">
        <div class="col-lg-5">
          <div class="contact-img-box position-relative border p-2 h-100">
            <img
              src="Frontend/assets/img/front-pages/icons/contact-border.png"
              alt="contact border"
              class="contact-border-img position-absolute d-none d-lg-block scaleX-n1-rtl"
            />
            <img
              src="Frontend/assets/img/front-pages/landing-page/contact-customer-service.png"
          ...
          <div class="card h-100">
            <div class="card-body">
              ...
              <p class="mb-6">
                ...
                account, licensing,<br class="d-none d-lg-block" />
